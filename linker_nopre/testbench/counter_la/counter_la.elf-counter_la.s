...
.Ltext0:
	...
	.file 0 "/home/bl605/SoC_Design/caravel-soc_fpga-lab/lab_D/testbench/counter_la" "counter_la.c"
...
.LFB316:
	...
	li	a5,1
.L2:
	.loc 1 73 43 is_stmt 1 discriminator 1
	.loc 1 73 10 is_stmt 0 discriminator 1
	lw	a4,0(s0)
	.loc 1 73 43 discriminator 1
	beq	a4,a5,.L2
	.loc 1 77 2 is_stmt 1
	.loc 1 77 114 is_stmt 0
	li	a5,-268423168
	sw	zero,12(a5)
	.loc 1 77 57
	sw	zero,28(a5)
	...
	.loc 1 83 56 is_stmt 0
	sw	zero,56(a5)
	.loc 1 86 2 is_stmt 1
	.loc 1 86 112 is_stmt 0
	sw	zero,8(a5)
	.loc 1 86 56
	sw	zero,24(a5)
...
.LASF0:
	.string	"counter_la.c"
.LASF1:
	.string	"/home/bl605/SoC_Design/caravel-soc_fpga-lab/lab_D/testbench/counter_la"
